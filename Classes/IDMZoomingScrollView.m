...
- (void)displayImage {
    if (_photo) {
       ...
       id tempObject = [self.photoBrowser imageForPhoto:_photo];

       UIImage *img;

       if ([tempObject isKindOfClass:[UIImage class]]) {
         img  =[self.photoBrowser imageForPhoto:_photo];

       }else if([tempObject isKindOfClass:[NSData class]]){
       img =[UIImage imageWithData:[self.photoBrowser imageForPhoto:_photo]];
